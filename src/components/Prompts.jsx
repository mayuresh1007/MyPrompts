...
const Prompts = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="text-xs text-violet-500 tracking-widest font-medium title-font mb-1">ROOF PARTY POLAROID</h2>
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          <div class="flex items-center mb-3">
            <div class="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-violet-500 text-white flex-shrink-0">
          ...
          <div class="flex-grow">
            ...
            <a class="mt-3 text-violet-500 inline-flex items-center">Learn More
