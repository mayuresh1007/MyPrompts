...
const Blogs = () => {
  return (
    <div className='justify-items-center items-center mx-auto'><section className="text-gray-600 body-font">
      ...
      <div className="flex flex-wrap -m-4">
        <div className="p-4 lg:w-1/3">
          <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
            ...
            <a className="text-violet-500 inline-flex items-center">Learn More
